...
function displayResults_aq(ap)
{
    ...
    let s02 = document.querySelector('.parameters-options .so2-value')
    s02.innerText = `${ap.results[2].value} µg/m³`;
    let n02 = document.querySelector('.parameters-options .no2-value')
    n02.innerText = `${ap.results[3].value} µg/m³`
